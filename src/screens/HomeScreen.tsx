...
export const HomeScreen: React.FC<HomeScreenProps> = ({
  ...
  const speakGreeting = () => {
    const message = isParent
      ? `Xin chào Phụ huynh ${activeProfile.name}. Báo cáo học tập của bé đã sẵn sàng.`
      : `Chào mừng ${activeProfile.name}! Hôm nay chúng ta cùng học toán thật vui nhé!`;
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.navBar}>
        ...
        <TouchableOpacity style={styles.profileBadge} onPress={onSwitchProfile}>
          <View
            style={[
              styles.miniAvatar,
          ...
          <Text style={styles.profileBadgeName}>{activeProfile.name}</Text>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        >
          <View style={styles.bannerInfo}>
            <Text style={styles.welcomeTag}>
              {isParent ? '🛡️ CHẾ ĐỘ PHỤ HUYNH' : `⭐ ${activeProfile.grade || 'HỌC SINH'}`}
            </Text>
            <Text style={styles.bannerTitle}>
              {isParent
                ? `Xin chào, ${activeProfile.name}`
                : `Hôm nay học gì thế, ${activeProfile.name}?`}
            </Text>
          ...
          <View style={styles.bannerAvatarBig}>
            <Text style={styles.bigAvatarEmoji}>{activeProfile.avatarIcon}</Text>
          </View>
        </View>

        {/* Dynamic Content: Kids Modules vs Parent Controls */}
        {!isParent ? (
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>📚 Bài học toán dành cho bé</Text>

            <View style={styles.cardsGrid}>
              <TouchableOpacity style={[styles.lessonCard, { backgroundColor: '#1E293B' }]}>
                <Text style={styles.cardEmoji}>➕➖</Text>
                <Text style={styles.cardTitle}>Phép Cộng & Trừ</Text>
                <Text style={styles.cardDesc}>10 bài tập vui nhộn với hình ảnh</Text>
                <View style={styles.startBadge}>
                  <Text style={styles.startBadgeText}>Bắt đầu ngay ▶</Text>
                </View>
              </TouchableOpacity>

              <TouchableOpacity style={[styles.lessonCard, { backgroundColor: '#311B92' }]}>
                <Text style={styles.cardEmoji}>📐🔺</Text>
                <Text style={styles.cardTitle}>Nhận Biết Hình Học</Text>
                <Text style={styles.cardDesc}>Hình vuông, hình tròn, tam giác</Text>
                <View style={styles.startBadge}>
                  <Text style={styles.startBadgeText}>Khám phá ▶</Text>
                </View>
              </TouchableOpacity>

              <TouchableOpacity style={[styles.lessonCard, { backgroundColor: '#004D40' }]}>
                <Text style={styles.cardEmoji}>🧩🧠</Text>
              ...
              <TouchableOpacity style={[styles.lessonCard, { backgroundColor: '#4A148C' }]}>
                <Text style={styles.cardEmoji}>🏆⏱️</Text>
                <Text style={styles.cardTitle}>Thi Đấu Tính Nhanh</Text>
                <Text style={styles.cardDesc}>Thử thách 60 giây đạt điểm cao</Text>
                <View style={styles.startBadge}>
          ...
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>📊 Báo cáo học tập & Quản lý</Text>
            ...
            <View style={styles.parentActionList}>
              <TouchableOpacity style={styles.parentActionItem}>
                ...
                <View style={styles.parentActionContent}>
                  <Text style={styles.parentActionTitle}>Giới hạn thời gian học</Text>
                  <Text style={styles.parentActionSub}>Đã đặt: Max 60 phút/ngày</Text>
                </View>
              ...
              <TouchableOpacity style={styles.parentActionItem}>
                ...
                <View style={styles.parentActionContent}>
                  ...
                  <Text style={styles.parentActionSub}>Mã PIN hiện tại: 1234</Text>
                </View>
                <Text style={styles.arrowText}>›</Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity style={styles.parentActionItem}>
                <Text style={styles.parentActionIcon}>👶</Text>
                <View style={styles.parentActionContent}>
                  <Text style={styles.parentActionTitle}>Quản lý danh sách Hồ sơ Bé</Text>
                  <Text style={styles.parentActionSub}>3 bé học viên đang hoạt động</Text>
                </View>
                <Text style={styles.arrowText}>›</Text>
              </TouchableOpacity>
            </View>
        ...
        <View style={styles.footerRow}>
          <TouchableOpacity style={styles.switchProfileBtn} onPress={onSwitchProfile}>
