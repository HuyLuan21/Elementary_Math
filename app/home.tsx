...
export default function HomeRoute() {
  ...
  // Fallback if accessed directly without active profile
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.navBar}>
        ...
        <TouchableOpacity style={styles.profileBadge} onPress={handleSwitchProfile}>
          <View style={[styles.miniAvatar, { backgroundColor: profile.avatarColor }]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={[styles.banner, isParent ? styles.parentBannerBg : styles.kidBannerBg]}>
          <View style={styles.bannerInfo}>
            <Text style={styles.welcomeTag}>
              {isParent ? '🛡️ CHẾ ĐỘ PHỤ HUYNH' : `⭐ ${profile.grade || 'HỌC SINH'}`}
            </Text>
            <Text style={styles.bannerTitle}>
              {isParent ? `Xin chào, ${profile.name}` : `Hôm nay học gì thế, ${profile.name}?`}
            </Text>
        ...
        <View style={styles.footerRow}>
          <TouchableOpacity style={styles.switchProfileBtn} onPress={handleSwitchProfile}>
